...
from flaskdemo.models import User, Photo, Notification
from flaskdemo.notifications import push_collect_notification, push_follow_notification


ajax_bp = Blueprint(name="ajax", import_name=__name__)
...
def followers_count(user_id):
    user = User.query.get_or_404(user_id)
    count = user.followers.count() - 1  # 该用户有多少个关注者
